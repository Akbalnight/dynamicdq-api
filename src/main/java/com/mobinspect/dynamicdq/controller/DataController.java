...
public class DataController {
    ...
    public List<ObjectNode> getFlatData(@PathVariable String configName, @RequestBody JsonNode filter, Pageable pageable){
    ...
    public List<ObjectNode> getHierarchicalData(@PathVariable String configName, @RequestBody JsonNode filter, Pageable pageable){
        long startNanos = System.nanoTime();
